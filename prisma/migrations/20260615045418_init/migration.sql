...
-- CreateIndex
CREATE UNIQUE INDEX "WrappedReport_userId_year_key" ON "WrappedReport"("userId", "year");
...
-- AddForeignKey
ALTER TABLE "Share" ADD CONSTRAINT "Share_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "WrappedReport"("id") ON DELETE CASCADE ON UPDATE CASCADE;
